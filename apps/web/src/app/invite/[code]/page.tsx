    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, marginBottom: 32 }}>
          <div style={{ width: 30, height: 30, borderRadius: 8, background: 'linear-gradient(135deg, var(--accent), var(--cyan))', boxShadow: '0 0 16px rgba(99,108,240,0.25)' }} />
          <span style={{ fontSize: 18, fontWeight: 700, color: 'var(--white)', letterSpacing: '-0.03em' }}>DevSim</span>
        </div>
