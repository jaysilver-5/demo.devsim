    ...
    <footer style={{ borderTop: "1px solid var(--border)", padding: "48px 24px", maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 15, fontWeight: 700, color: "var(--white)" }}>DevSim</span>
        </div>
        <span style={{ fontSize: 12, color: "rgba(139,143,163,0.3)" }}>© 2026 DevSim. All rights reserved.</span>
      </div>
    </footer>
  );
}